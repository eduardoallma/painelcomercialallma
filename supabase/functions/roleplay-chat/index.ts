...
const CLIENT_PROFILES = [
  ...
  },
  {
    ...
    role: "Sócio",
    company: "BarrosFit Suplementos",
    segment: "Loja física de suplementos",
    revenue: "R$2.5M/ano",
    teamSize: "8 pessoas",
    personality: "Impulsivo e ansioso por resultado. Quer tudo pra ontem. Se não vir retorno rápido, cancela.",
    trafficInvestment: "Até R$ 1.000",
    trafficResult: "Não trouxe nenhum retorno",
    mainChallenge: "Falta de previsibilidade",
    pains: [
      "Movimento caiu desde que abriu uma loja concorrente na mesma rua",
      "Só usa Instagram orgânico e WhatsApp para vender",
      "Não sabe quanto custa cada cliente novo",
      "Estoque parado de produtos caros",
    ],
    budget: { range: "R$2k a R$5k/mês", willingness: "Quer investir pouco e ver retorno em 30 dias" },
    authority: "Decide sozinho, é sócio majoritário",
    urgency: "Alta — faturamento caiu 25% nos últimos 3 meses",
    objections: [
      "Já impulsionei post e não vendeu nada",
      "Meu público compra na loja, não na internet",
      "Se não der resultado em 1 mês eu cancelo",
    ],
  },
  {
    name: "Renata Dias",
    role: "Diretora de Operações",
    company: "CleanPro Facilities",
    segment: "Facilities / Limpeza empresarial",
    revenue: "R$15M/ano",
    teamSize: "300 pessoas (maioria operacional)",
    personality: "Pragmática e sem rodeios. Quer proposta objetiva com números claros. Não tem tempo para reuniões longas.",
    trafficInvestment: "Não investi nada",
    trafficResult: "Não trouxe nenhum retorno",
    mainChallenge: "Dependência de indicações para fechar novas vendas",
    pains: [
      "100% dos contratos vêm de indicação e licitação",
      "Não tem presença digital nenhuma",
      "Concorrentes menores ganhando contratos via Google",
      "Processo comercial manual e sem CRM",
    ],
    budget: { range: "R$5k a R$15k/mês", willingness: "Empresa lucrativa mas nunca investiu em digital" },
    authority: "Decide junto com o CEO, precisa apresentar proposta formal",
    urgency: "Média — pipeline de contratos novos secou",
    objections: [
      "Nosso mercado é B2B, ninguém contrata limpeza por anúncio",
      "Nossos contratos são de R$50k+, ciclo longo",
      "Prefiro investir em um vendedor externo do que em tráfego",
    ],
  },
  {
    name: "Lucas Tavares",
    role: "CEO",
    company: "PizzaExpress Delivery",
    segment: "Pizzaria / Delivery",
    revenue: "R$4M/ano",
    teamSize: "30 pessoas",
    personality: "Desconfiado mas curioso. Já foi enganado por agência antes. Testa o vendedor com perguntas capciosas.",
    trafficInvestment: "Entre R$ 1.000 e R$ 3.000",
    trafficResult: "Sim, mas menos do que gostaria",
    mainChallenge: "Receio de investir mais em Tráfego, sem segurança de resultados",
    pains: [
      "iFood cobra 27% de comissão e aumentando",
      "Tentou Google Ads mas o custo por pedido ficou alto",
      "Não tem app próprio nem site otimizado para pedidos",
      "Concorrentes com frete grátis patrocinado nos apps",
    ],
    budget: { range: "R$3k a R$10k/mês", willingness: "Tem caixa mas não confia em agência após experiência ruim" },
    authority: "Dono, decide tudo",
    urgency: "Alta — margem sendo comida pelas plataformas",
    objections: [
      "Última agência me prometeu 5x de retorno e não entregou 1x",
      "Meu cliente já tá no iFood, não vai baixar meu app",
      "Quero garantia de resultado, vocês dão?",
    ],
  },
  {
    ...
    revenue: "R$3.5M/ano",
    teamSize: "20 pessoas",
    personality: "Apaixonada por animais, emocional. Mistura pessoal com profissional. Precisa sentir que o vendedor entende seu propósito.",
    trafficInvestment: "Até R$ 1.000",
    trafficResult: "Não trouxe nenhum retorno",
    mainChallenge: "Dependência de indicações para fechar novas vendas",
    pains: [
      "Agenda de consultas com buracos, cirurgias subtilizadas",
      "Só usa Instagram com fotos de pets mas sem estratégia",
      "Não aparece no Google quando buscam 'veterinário perto de mim'",
      "Pet shops com vet embutido roubando clientes",
    ],
    budget: { range: "R$3k a R$8k/mês", willingness: "Investiria se visse plano focado em atrair tutores de pets" },
    authority: "Decide com a outra sócia veterinária",
    urgency: "Média — inaugurou segunda unidade e precisa lotar",
    objections: [
      "Não quero atrair cliente que só quer vacina barata",
      "Minha agenda de emergência é cheia, preciso de consultas eletivas",
      "Já tentei panfletar e não funcionou, digital é diferente?",
    ],
  },
  {
    name: "André Lopes",
    ...
    segment: "Logística / Transportadora",
    revenue: "R$40M/ano",
    teamSize: "180 pessoas",
    personality: "Corporativo e metódico. Fala devagar, pensa antes de responder. Valoriza processos e compliance.",
    trafficInvestment: "Não investi nada",
    trafficResult: "Não trouxe nenhum retorno",
    mainChallenge: "Falta de previsibilidade",
    pains: [
      "Depende de 5 grandes clientes para 70% do faturamento",
      "Precisa diversificar carteira mas não sabe gerar demanda",
      "Site institucional sem formulário de cotação",
      "Concorrentes com Google Ads aparecendo em buscas de frete",
    ],
    budget: { range: "R$10k a R$25k/mês", willingness: "Budget existe mas precisa de business case para o board" },
    authority: "Propõe ao board, decisão colegiada",
    urgency: "Média — perdeu um grande cliente e precisa repor receita",
    objections: [
      "Nosso negócio é B2B pesado, não se vende frete por clique",
      "Nosso ciclo comercial é de 3 meses, como medir ROI?",
      "Precisamos de relacionamento, não de lead frio",
    ],
  },
  {
    name: "Tatiana Braga",
    role: "Fundadora",
    company: "MamaeBaby Enxoval",
    segment: "E-commerce de enxoval e bebê",
    revenue: "R$6M/ano",
    teamSize: "18 pessoas",
    personality: "Detalhista e perfeccionista. Se preocupa muito com a experiência do cliente. Quer parceiro que entenda seu público.",
    trafficInvestment: "Entre R$ 3.000 e R$ 15.000",
    trafficResult: "Sim, mas menos do que gostaria",
    mainChallenge: "Receio de investir mais em Tráfego, sem segurança de resultados",
    pains: [
      "Sazonalidade forte — chá de bebê concentrado em certas épocas",
      "Pinterest e Google Shopping com ROAS declinante",
      "Ticket médio alto (R$350) mas conversão baixa",
      "Dificuldade em atingir gestantes no momento certo",
    ],
    budget: { range: "R$8k a R$20k/mês", willingness: "Tem verba mas quer estratégia sazonal bem definida" },
    authority: "Decide sozinha, é a fundadora",
    urgency: "Alta — temporada de chá de bebê começa em 2 meses",
    objections: [
      "Meu público pesquisa muito antes de comprar, como acelerar isso?",
      "Google Shopping ficou caro demais com a concorrência",
      "Preciso de alguém que entenda o universo materno",
    ],
  },
  {
    name: "Rafael Cunha",
    role: "Gerente de Marketing",
    company: "TurboMecânica Auto Center",
    segment: "Auto center / Mecânica",
    revenue: "R$5M/ano",
    teamSize: "25 pessoas",
    personality: "Jovem e aberto a novidades. Quer modernizar o negócio da família. Mas precisa convencer o pai que é o dono.",
    trafficInvestment: "Até R$ 1.000",
    trafficResult: "Sim, mas menos do que gostaria",
    mainChallenge: "Falta de previsibilidade",
    pains: [
      "Depende de passagem de carro na frente da oficina",
      "Google Meu Negócio desatualizado com poucas avaliações",
      "Não rastreia de onde vêm os clientes",
      "Concorrentes de franquia com marketing pesado na região",
    ],
    budget: { range: "R$3k a R$8k/mês", willingness: "Ele quer investir mas o pai acha gasto desnecessário" },
    authority: "Influenciador — pai é o dono e toma a decisão final",
    urgency: "Média — movimento estável mas sem crescimento há 2 anos",
    objections: [
      "Meu pai acha que marketing é jogar dinheiro fora",
      "Nosso cliente não marca hora, chega quando o carro quebra",
      "Como convencer meu pai a aprovar isso?",
    ],
  },
  {
    name: "Carla Mendonça",
    role: "Sócia-proprietária",
    company: "EspaçoBeleza Salão",
    segment: "Salão de beleza / Estética",
    revenue: "R$1.8M/ano",
    teamSize: "12 pessoas",
    personality: "Simpática e aberta mas indecisa. Gosta de ouvir opções mas tem dificuldade em tomar decisão. Precisa de empurrão.",
    trafficInvestment: "Até R$ 1.000",
    trafficResult: "Não trouxe nenhum retorno",
    mainChallenge: "Dependência de indicações para fechar novas vendas",
    pains: [
      "Cadeiras vazias durante a semana, lotado só no sábado",
      "Instagram bonito mas não converte em agendamentos",
      "Não tem sistema de agendamento online integrado",
      "Profissionais saindo para abrir salão próprio e levando clientes",
    ],
    budget: { range: "R$2k a R$5k/mês", willingness: "Tem caixa limitado, precisa ver retorno claro" },
    authority: "Decide com a sócia, as duas precisam concordar",
    urgency: "Alta — perdeu 3 profissionais e precisa repor clientela",
    objections: [
      "Já paguei pra fazer post bonito e não veio ninguém",
      "Meu público é do bairro, tráfego pago não é exagero?",
      "E se eu investir e as profissionais saírem de novo?",
    ],
  },
  {
    name: "Marcelo Vianna",
    role: "CEO",
    company: "AgroVida Insumos",
    segment: "Agronegócio / Insumos agrícolas",
    revenue: "R$80M/ano",
    teamSize: "150 pessoas",
    personality: "Tradicional e direto. Mede tudo em hectares e sacas. Se o vendedor não entender agro, perde credibilidade imediato.",
    trafficInvestment: "Não investi nada",
    trafficResult: "Não trouxe nenhum retorno",
    mainChallenge: "Dependência de indicações para fechar novas vendas",
    pains: [
      "Equipe de vendas no campo mas sem geração de demanda digital",
      "Concorrentes fazendo webinars e captando produtores online",
      "Não tem CRM nem rastreamento do funil comercial",
      "Sazonalidade forte — precisa vender na janela de plantio",
    ],
    budget: { range: "R$15k a R$40k/mês", willingness: "Empresa tem muito recurso mas direção é conservadora" },
    authority: "CEO mas consulta o conselho para investimentos novos",
    urgency: "Média — safra começa em 4 meses, janela de venda se aproximando",
    objections: [
      "Produtor rural não compra insumo por internet",
      "Nosso vendedor de campo já faz esse trabalho",
      "Não conheço ninguém do agro que use tráfego pago",
    ],
  },
  {
    name: "Priscila Fonseca",
    role: "Head de Marketing",
    company: "VidaPlena Seguros",
    segment: "Corretora de seguros",
    revenue: "R$12M/ano",
    teamSize: "35 pessoas",
    personality: "Estratégica e exigente. Já trabalhou em multinacional e tem padrão alto. Cobra profissionalismo e pontualidade.",
    trafficInvestment: "Entre R$ 3.000 e R$ 15.000",
    trafficResult: "Sim, mas menos do que gostaria",
    mainChallenge: "Dificuldade em contratar e reter um Time de Marketing qualificado",
    pains: [
      "Leads de seguro auto com conversão abaixo de 2%",
      "Google Ads caro em keywords de seguro",
      "Não tem estratégia de conteúdo para gerar autoridade",
      "Corretores preferem indicação e não trabalham leads digitais",
    ],
    budget: { range: "R$10k a R$30k/mês", willingness: "Budget aprovado mas precisa provar eficiência para renovar" },
    authority: "Gerencia o marketing mas CEO aprova contratos",
    urgency: "Alta — meta de novos clientes está 40% abaixo do target",
    objections: [
      "Lead de seguro é muito sensível a preço, vira leilão",
      "Nossos corretores não ligam rápido para os leads",
      "Já testamos e o custo por apólice fechada é inviável",
    ],
  },
  {
    name: "Bruno Teixeira",
    role: "Fundador",
    company: "CodeKids Escola",
    segment: "Escola de programação para crianças",
    revenue: "R$1.2M/ano",
    teamSize: "10 pessoas",
    personality: "Entusiasmado e idealista. Acredita muito no produto mas não entende de marketing. Aberto a aprender.",
    trafficInvestment: "Até R$ 1.000",
    trafficResult: "Não trouxe nenhum retorno",
    mainChallenge: "Falta de previsibilidade",
    pains: [
      "Turmas com apenas 50% de ocupação",
      "Só consegue alunos por indicação de pais",
      "Não sabe usar Meta Ads para atingir pais de 6-14 anos",
      "Concorrência de cursos online gratuitos no YouTube",
    ],
    budget: { range: "R$2k a R$6k/mês", willingness: "Startup com caixa limitado mas disposto a investir se fizer sentido" },
    authority: "Decide sozinho",
    urgency: "Alta — matrículas do próximo semestre começam em 6 semanas",
    objections: [
      "Meu público são os pais, como segmentar isso no tráfego?",
      "Cursos online são grátis, como competir?",
      "Meu ticket é R$300/mês, o CAC precisa ser baixo",
    ],
  },
  {
    name: "Daniela Reis",
    role: "Diretora Comercial",
    company: "MedEquip Hospitalar",
    segment: "Equipamentos hospitalares B2B",
    revenue: "R$45M/ano",
    teamSize: "60 pessoas",
    personality: "Séria e focada em compliance. Tudo precisa estar documentado. Processo de decisão formal e longo.",
    trafficInvestment: "Não investi nada",
    trafficResult: "Não trouxe nenhum retorno",
    mainChallenge: "Dependência de indicações para fechar novas vendas",
    pains: [
      "Vendas 100% via relacionamento com compradores hospitalares",
      "Processo de venda de 6-12 meses sem automação",
      "Não participa de licitações eletrônicas com visibilidade digital",
      "Concorrentes internacionais com presença forte no Google",
    ],
    budget: { range: "R$15k a R$35k/mês", willingness: "Verba existe mas precisa de aprovação da diretoria e compliance" },
    authority: "Influenciadora — diretoria e compliance precisam aprovar",
    urgency: "Baixa — processo interno de aprovação leva 2-3 meses",
    objections: [
      "Nosso mercado é muito regulado, não podemos fazer qualquer anúncio",
      "Nossos compradores são hospitalares, não buscam no Google",
      "Precisamos de ABM, não de tráfego genérico",
    ],
  },
  {
    name: "Otávio Nascimento",
    role: "Proprietário",
    company: "GourmetBurger Hamburgueria",
    segment: "Hamburgueria artesanal",
    revenue: "R$2.8M/ano",
    teamSize: "20 pessoas",
    personality: "Criativo e ligado em tendências. Entende de branding mas não de performance. Quer crescer sem perder a identidade.",
    trafficInvestment: "Entre R$ 1.000 e R$ 3.000",
    trafficResult: "Sim, mas menos do que gostaria",
    mainChallenge: "Receio de investir mais em Tráfego, sem segurança de resultados",
    pains: [
      "Delivery dependente 100% do iFood e Rappi",
      "Instagram com 30k seguidores mas não converte em pedidos",
      "Não tem programa de fidelidade nem base de clientes",
      "Custo do delivery comendo toda a margem",
    ],
    budget: { range: "R$3k a R$8k/mês", willingness: "Quer investir mas precisa ver estratégia que proteja a marca" },
    authority: "Dono, decide sozinho",
    urgency: "Média — quer lançar delivery próprio nos próximos 3 meses",
    objections: [
      "Não quero parecer 'promoção de fast food', minha marca é premium",
      "iFood já me dá visibilidade, por que investir fora?",
      "Meu ticket médio é R$50, compensa tráfego pago?",
    ],
  },
  {
    name: "Simone Alves",
    role: "Gerente de Marketing",
    company: "EcoHouse Construções",
    segment: "Construção sustentável",
    revenue: "R$22M/ano",
    teamSize: "50 pessoas",
    personality: "Engajada com sustentabilidade e propósito. Quer parceiro alinhado com valores da empresa. Rejeita abordagens puramente comerciais.",
    trafficInvestment: "Entre R$ 3.000 e R$ 15.000",
    trafficResult: "Sim, mas menos do que gostaria",
    mainChallenge: "Falta de previsibilidade",
    pains: [
      "Público-alvo muito específico — classe A interessada em sustentabilidade",
      "Google Ads traz curiosos que não têm orçamento para construir",
      "Conteúdo educativo consome muito tempo sem gerar lead qualificado",
      "Ciclo de decisão de 6-12 meses para construção",
    ],
    budget: { range: "R$10k a R$25k/mês", willingness: "Budget aprovado mas quer estratégia alinhada ao posicionamento sustentável" },
    authority: "Gerencia marketing mas CEO aprova contratos",
    urgency: "Média — meta de 15 novos projetos este ano, só fechou 4",
    objections: [
      "Não queremos anúncios agressivos, precisa ser educativo",
      "Nosso cliente não decide por impulso, o funil é longo",
      "Como segmentar classe A interessada em casa sustentável?",
    ],
  },
  {
    name: "Jorge Medeiros",
    role: "Diretor",
    company: "SafeGuard Segurança",
    segment: "Segurança patrimonial / Monitoramento",
    revenue: "R$10M/ano",
    teamSize: "200 pessoas (maioria operacional)",
    personality: "Objetivo e sem firulas. Fala em números e contratos. Se não falar de resultado financeiro rápido, perde interesse.",
    trafficInvestment: "Entre R$ 1.000 e R$ 3.000",
    trafficResult: "Não trouxe nenhum retorno",
    mainChallenge: "Falta de previsibilidade",
    pains: [
      "Depende de indicação e licitação para novos contratos",
      "Google Ads traz leads residenciais quando o foco é empresarial",
      "Site não transmite credibilidade e profissionalismo",
      "Concorrentes nacionais com marca forte e tráfego pago pesado",
    ],
    budget: { range: "R$5k a R$15k/mês", willingness: "Investiria se provarem retorno com contratos B2B" },
    authority: "Decide sozinho como diretor e sócio majoritário",
    urgency: "Alta — perdeu 2 contratos grandes e precisa repor receita",
    objections: [
      "Segurança é confiança, não se contrata por anúncio",
      "Nosso contrato médio é R$8k/mês, o ciclo é longo",
      "Preciso de leads empresariais, não residenciais",
    ],
  },
  {
    name: "Natália Rocha",
    ...
    segment: "Yoga / Meditação",
    revenue: "R$800k/ano",
    teamSize: "6 pessoas",
    personality: "Calma e reflexiva. Não gosta de pressão comercial. Valoriza autenticidade e conexão. Demora para decidir.",
    trafficInvestment: "Não investi nada",
    trafficResult: "Não trouxe nenhum retorno",
    mainChallenge: "Dependência de indicações para fechar novas vendas",
    pains: [
      "Studio com capacidade para 20 alunos por aula, média de 8",
      "Só divulga boca a boca e stories pessoais",
      "Não sabe como atrair público que paga mensalidade premium",
      "Apps de meditação online competindo com aulas presenciais",
    ],
    budget: { range: "R$1.5k a R$4k/mês", willingness: "Margem apertada, precisa ter certeza antes de investir" },
    authority: "Decide sozinha, é a fundadora",
    urgency: "Média — aluguel fixo alto e precisa de mais alunos para cobrir",
    objections: [
      "Yoga é algo espiritual, propaganda paga parece forçado",
      "Meu público não é de redes sociais tradicionais",
      "Headspace e Calm oferecem meditação grátis, como competir?",
    ],
  },
  {
    name: "Alessandro Santos",
    role: "Sócio-diretor",
    company: "TechPrint Gráfica",
    segment: "Gráfica / Comunicação visual",
    revenue: "R$7M/ano",
    teamSize: "40 pessoas",
    personality: "Técnico e prático. Conhece seu produto a fundo. Quer parceiro que entenda a cadeia de produção gráfica.",
    trafficInvestment: "Até R$ 1.000",
    trafficResult: "Sim, mas menos do que gostaria",
    mainChallenge: "Dificuldade em contratar e reter um Time de Marketing qualificado",
    pains: [
      "Mercado gráfico encolhendo com digitalização",
      "Precisa migrar para comunicação visual e grandes formatos",
      "Google Ads traz orçamentos pequenos que não compensam",
      "Não tem e-commerce para produtos padronizados",
    ],
    budget: { range: "R$5k a R$12k/mês", willingness: "Quer investir em digital para compensar queda do impresso" },
    authority: "Decide com o outro sócio, precisam concordar",
    urgency: "Alta — faturamento caiu 20% no último ano",
    objections: [
      "Gráfica é commodity, como se diferenciar no digital?",
      "Nossos clientes são agências, não consumidor final",
      "Canva e impressão online estão matando o mercado",
    ],
  },
  {
    name: "Cristina Barbosa",
    role: "Diretora de Expansão",
    company: "LinguaPro Idiomas",
    segment: "Escola de idiomas",
    revenue: "R$9M/ano",
    teamSize: "45 pessoas (30 professores)",
    personality: "Estratégica e orientada a métricas. Ex-consultora, fala em KPIs. Quer parceiro que acompanhe seu ritmo analítico.",
    trafficInvestment: "Entre R$ 3.000 e R$ 15.000",
    trafficResult: "Sim, mas menos do que gostaria",
    mainChallenge: "Todas as opções acima",
    pains: [
      "CPL subindo no Google para keywords de inglês/espanhol",
      "Concorrência de apps gratuitos como Duolingo",
      "Taxa de no-show na aula experimental acima de 40%",
      "Retenção de alunos caindo — churn de 8% ao mês",
    ],
    budget: { range: "R$12k a R$30k/mês", willingness: "Verba aprovada para expansão, quer investir com inteligência" },
    authority: "Tem autonomia para marketing, reporta ao board",
    urgency: "Alta — inaugurando 2 novas unidades e precisa de tração",
    objections: [
      "Duolingo é grátis, como justificar escola presencial?",
      "No-show na experimental é meu maior problema, tráfego resolve?",
      "Já temos marca forte, preciso de conversão não de awareness",
    ],
  },
];
